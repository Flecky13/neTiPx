...
/// <summary>
/// Service to retrieve detailed network adapter information.
/// </summary>
public sealed class NetworkInfoService
{
    ...
    /// <summary>
    /// Gets detailed network information for a specific adapter.
    /// </summary>
    /// <param name="adapterName">Name or description of the network adapter.</param>
    /// <returns>2D array with labels and values, or null if adapter not found.</returns>
    ...
    /// <summary>
    /// Gets IPv4 configuration for a specific adapter.
    /// </summary>
    ...
    /// <summary>
    /// Finds a network adapter by name or description.
    /// </summary>
